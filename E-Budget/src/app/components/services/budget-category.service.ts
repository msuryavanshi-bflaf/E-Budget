...
export class BudgetCategoryService {
  ...
  //   return this.http.put(environment.javaEndPoint + API_END_POINTS.EDIT_CATEGORY, createBudgetCategoryRequest).pipe(map((res: any) => {
  //     return res;
  //   }))
  // }

  getActiveCategory(): Observable<BudgetCategoryDetails> {
    return this.http.get(environment.javaEndPoint + API_END_POINTS.BUDGET_CATEGORY_LIST).pipe(
  ...
  getBudgetCategoryDetails(id: any) {
    return this.http.get(environment.javaEndPoint + API_END_POINTS.BUDGET_CATEGORY_LIST + id).pipe(
      map((res: any) => { return (res) })
    );
  }
  ...
  public deleteCategory(id: any) {
    return this.http.delete(environment.javaEndPoint + API_END_POINTS.DELETE_CATEGORY + id)
  }


  editCategory(id: String, createBudgetCategoryRequest: BudgetCategoryData): Observable<Object> {
    return this.http.put(environment.javaEndPoint + API_END_POINTS.EDIT_CATEGORY + id, createBudgetCategoryRequest);
  }
