...
import { POData, poDetails } from 'src/app/Model/po-generation/po-generation.module';
...
export class PoGenerateComponent {
  ...
  myArr: any;
  updatedAmount: any;
  tableHead = ['PO Stage', 'PO Number',  'Budget Code', 'Vendor Name','PO Date','PO Expiry Date'];
  poData: poDetails[] = [];
  
  constructor(private router: Router, private fb: FormBuilder, private vendorService: VendorService, private poService:PoService,private budgetCreationService: BudgetCreationService) { }
  ...
  initAmountList() {
    ...
    // console.log("select index of amount ",this.budgetCreationList);
  }
